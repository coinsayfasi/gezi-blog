...
<link rel="apple-touch-icon" href="/apple-touch-icon.png"><link rel="manifest" href="/manifest.json"><meta name="theme-color" content="#000000">
...
<style>:root{--bg:#000000;--card:#202020;--ink:#ffffff;--muted:#999999;--accent:#f5f5f0;--accent2:#f5f5f0;--accent3:#f5f5f0;--line:#333333;--shadow:none}*{box-sizing:border-box;margin:0;padding:0}body{font-family:'Inter',-apple-system,BlinkMacSystemFont,sans-serif;background:var(--bg);color:var(--ink);line-height:1.75;-webkit-font-smoothing:antialiased;overflow-x:hidden}.wrap{max-width:1080px;margin:0 auto;padding:0 22px}nav{position:sticky;top:0;z-index:40;background:rgba(0,0,0,.82);border-bottom:1px solid var(--line)}nav .nwrap{max-width:1080px;margin:0 auto;padding:0 22px;display:flex;align-items:center;justify-content:space-between;height:64px}.logo{display:flex;align-items:center;gap:10px;font-weight:700;font-size:19px;color:var(--ink);text-decoration:none}.logo img{width:30px;height:30px;border-radius:9px}.nav-links a{color:var(--muted);text-decoration:none;font-size:14.5px;font-weight:600;margin-left:24px}h1,h2{font-family:'Inter',sans-serif;font-weight:500}.page{padding:46px 0 30px}.aurora{position:fixed;inset:0;z-index:-2;background:var(--bg)}a{color:var(--accent);text-decoration:none}.site-footer{margin-top:64px;border-top:1px solid var(--line);background:var(--bg)}.foot-grid{display:grid;grid-template-columns:1.6fr 1fr 1fr 1fr;gap:32px;padding:46px 22px 32px;max-width:1080px;margin:0 auto}@media(max-width:640px){.foot-grid{grid-template-columns:1fr 1fr}}.foot-col a{display:block;color:var(--muted);font-size:14px;margin-bottom:11px}.foot-brand p{color:var(--muted);font-size:14px;margin-top:12px;max-width:280px}.fh{font-size:12.5px;text-transform:uppercase;letter-spacing:.1em;color:var(--ink);font-weight:700;margin-bottom:14px}.foot-bottom{border-top:1px solid var(--line)}.foot-bottom .wrap{display:flex;justify-content:space-between;padding:18px 22px;font-size:13px;color:var(--muted)}.chipwrap{text-align:center}.chiplbl{display:block;font-size:12px;letter-spacing:.22em;text-transform:uppercase;font-weight:700;color:var(--muted);margin-bottom:12px}.chips{display:flex;gap:9px;flex-wrap:wrap;justify-content:center;margin-bottom:24px}.chips a{font-size:13.5px;font-weight:600;padding:8px 15px;border-radius:999px;border:1px solid var(--line);background:var(--card);color:var(--ink)}.posts{display:grid;grid-template-columns:repeat(auto-fit,minmax(290px,1fr));gap:22px}.pcard{display:block;background:var(--card);border:1px solid var(--line);border-radius:18px;padding:26px;color:var(--ink)}.pcard p{color:var(--muted);font-size:14.5px}.appbadges{display:flex;gap:10px;flex-wrap:wrap;align-items:center;margin-top:14px}.appbadges a{font-size:13.5px;font-weight:700;padding:10px 16px;border-radius:11px;background:transparent;border:1px solid #fff;color:#fff}.related{border:1px solid var(--line);border-radius:16px;padding:22px 24px;background:#fff;margin:36px 0 10px}.related ul{list-style:none;margin:0;padding:0}.related a{display:block;padding:12px 2px;color:var(--ink);font-weight:600}.share{display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin:26px 0 6px;padding-top:18px;border-top:1px solid var(--line);color:var(--muted);font-size:14px}.share .ico{display:inline-flex;align-items:center;justify-content:center;width:38px;height:38px;border-radius:50%;border:1px solid var(--line);color:var(--muted)}</style>
...
<div id="cookie-banner" style="display:none;position:fixed;left:0;right:0;bottom:0;z-index:9999;background:#202020;border-top:1px solid #333333;box-shadow:0 -4px 20px rgba(0,0,0,.4);padding:13px 18px;font-size:13.5px;color:#e6e6e6;line-height:1.5"><div style="max-width:1080px;margin:0 auto;display:flex;gap:14px;align-items:center;flex-wrap:wrap;justify-content:center"><span>We use cookies for analytics and advertising (incl. Google AdSense). See our <a href="/cookies.html" style="color:#f5f5f0">Cookie Policy</a>.</span><span style="display:flex;gap:8px"><button onclick="cookieOK(true)" style="background:#f5f5f0;color:#000;border:0;padding:8px 16px;border-radius:9999px;font-weight:500;cursor:pointer">Accept</button><button onclick="cookieOK(false)" style="background:transparent;color:#999999;border:1px solid #333333;padding:8px 16px;border-radius:9999px;font-weight:500;cursor:pointer">Decline</button></span></div></div><script>(function(){{try{{if(!localStorage.getItem("cookie_consent"))document.getElementById("cookie-banner").style.display="block";}}catch(e){{}}}})();function cookieOK(v){{try{{localStorage.setItem("cookie_consent",v?"accepted":"rejected");}}catch(e){{}}document.getElementById("cookie-banner").style.display="none";}}</script>
</body>
</html>
"""
...
def write_post(d, app, posts=()):
    ...
    _ttl=d["title"]; _sfx=" | Türkiye Gezi Rehberi"; _ttag=(_ttl+_sfx) if len(_ttl+_sfx)<=60 else (_ttl if len(_ttl)<=60 else _ttl[:60].rsplit(" ",1)[0]); page = (PAGE.replace("__TITLETAG__", html.escape(_ttag)).replace("__TITLE__", html.escape(d["title"])).replace("__DESC__", html.escape(d["meta_description"]))
...
"""
    ...
    regions_html = ('<section class="reveal" style="max-width:1080px;margin:8px auto 0">'
      ...
      + "".join(f'<a href="/{s}/" style="display:block;background:var(--card);border:1px solid var(--line);border-radius:16px;padding:22px;color:var(--ink);box-shadow:var(--shadow)"><div style="font-size:30px;line-height:1">{e}</div><h3 style="font-family:\'Sora\',sans-serif;font-size:19px;margin:10px 0 6px">{n}</h3><p style="color:var(--muted);font-size:14px;line-height:1.6;margin:0">{d}</p></a>' for s,n,e,d in _regions)
      + '</div></section>')
    ...
    cities_html = ('<section class="reveal" style="max-width:1080px;margin:46px auto 0">'
      ...
      + "".join(f'<a href="/blog/{s}/" style="padding:11px 19px;border-radius:999px;border:1px solid var(--line);background:var(--card);color:var(--ink);font-weight:600;font-size:14.5px;box-shadow:var(--shadow)">{n}</a>' for s,n in _pcities if s in _have)
      + '</div></section>')
  ...
  <h2 style="font-family:'Inter',sans-serif;font-weight:500;font-size:27px;color:var(--ink);margin-bottom:14px">Türkiye Gezi Rehberi: Nereye, Ne Zaman, Nasıl?</h2>
  ...
  <h3 style="font-family:'Inter',sans-serif;font-weight:500;font-size:21px;color:var(--ink);margin:26px 0 10px">Bölge Bölge Türkiye</h3>
  ...
  <h3 style="font-family:'Inter',sans-serif;font-weight:500;font-size:21px;color:var(--ink);margin:26px 0 10px">Ne Zaman Gidilir?</h3>
  <p>Doğru mevsim, gezinin keyfini ikiye katlar. Kabaca bir yol haritası:</p>
  <div style="overflow-x:auto;margin:8px 0 4px"><table style="width:100%;border-collapse:collapse;font-size:15px;background:var(--card);border:1px solid var(--line);border-radius:12px;overflow:hidden">
   <thead><tr style="background:var(--card);text-align:left"><th style="padding:11px 14px">Bölge</th><th style="padding:11px 14px">En İyi Dönem</th><th style="padding:11px 14px">Öne Çıkan</th></tr></thead>
   <tbody>
  ...
  <h3 style="font-family:'Inter',sans-serif;font-weight:500;font-size:21px;color:var(--ink);margin:26px 0 10px">Rota Nasıl Planlanır?</h3>
  ...
  <h3 style="font-family:'Inter',sans-serif;font-weight:500;font-size:21px;color:var(--ink);margin:26px 0 10px">Ulaşım, Konaklama ve Bütçe</h3>
...
<header style="text-align:center;padding:70px 22px 30px">
  ...
  <h1 style="font-family:'Inter',sans-serif;font-weight:500;font-size:clamp(24px,5vw,48px);font-weight:800;letter-spacing:-.02em;margin:16px 0 12px">Türkiye Gezi Rehberi:<br>81 İl, İlçe İlçe Gezilecek Yerler</h1>
...
{regions_html}
{cities_html}
  <h2 style="font-family:'Inter',sans-serif;font-weight:500;font-size:27px;text-align:center;margin:48px 0 4px;color:var(--ink)">Son Gezi Rehberleri</h2>
