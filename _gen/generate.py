...
<link rel="apple-touch-icon" href="/apple-touch-icon.png"><link rel="manifest" href="/manifest.json"><meta name="theme-color" content="#234386">
...
<div id="cookie-banner" style="display:none;position:fixed;left:0;right:0;bottom:0;z-index:9999;background:#fff;border-top:1px solid #e5e5e5;box-shadow:0 -4px 20px rgba(0,0,0,.08);padding:13px 18px;font-size:13.5px;color:#384250;line-height:1.5"><div style="max-width:1080px;margin:0 auto;display:flex;gap:14px;align-items:center;flex-wrap:wrap;justify-content:center"><span>We use cookies for analytics and advertising (incl. Google AdSense). See our <a href="/cookies.html" style="color:#1d4ed8">Cookie Policy</a>.</span><span style="display:flex;gap:8px"><button onclick="cookieOK(true)" style="background:#059669;color:#fff;border:0;padding:8px 16px;border-radius:8px;font-weight:600;cursor:pointer">Accept</button><button onclick="cookieOK(false)" style="background:#eee;color:#333;border:0;padding:8px 16px;border-radius:8px;font-weight:600;cursor:pointer">Decline</button></span></div></div><script>(function(){{try{{if(!localStorage.getItem("cookie_consent"))document.getElementById("cookie-banner").style.display="block";}}catch(e){{}}}})();function cookieOK(v){{try{{localStorage.setItem("cookie_consent",v?"accepted":"rejected");}}catch(e){{}}document.getElementById("cookie-banner").style.display="none";}}</script>
</body>
</html>
"""
...
"""
    ...
    faq_html = ('<section class="reveal" style="max-width:780px;margin:44px auto 6px"><h2 style="font-family:\'Oswald\',sans-serif;font-size:25px;color:var(--ink);margin-bottom:16px">Sık Sorulan Sorular</h2>'
    ...
    regions_html = ('<section class="reveal" style="max-width:1080px;margin:8px auto 0">'
      '<h2 style="font-family:\'Oswald\',sans-serif;font-size:27px;text-align:center;margin:10px 0 4px;color:var(--ink)">Bölgelere Göre Keşfet</h2>'
    ...
    cities_html = ('<section class="reveal" style="max-width:1080px;margin:46px auto 0">'
      '<h2 style="font-family:\'Oswald\',sans-serif;font-size:27px;text-align:center;margin:10px 0 4px;color:var(--ink)">Popüler Şehirler</h2>'
  ...
  <h2 style="font-family:'Oswald',sans-serif;font-size:27px;color:var(--ink);margin-bottom:14px">Türkiye Gezi Rehberi: Nereye, Ne Zaman, Nasıl?</h2>
  ...
  <h3 style="font-family:'Oswald',sans-serif;font-size:21px;color:var(--ink);margin:26px 0 10px">Bölge Bölge Türkiye</h3>
  ...
  <h3 style="font-family:'Oswald',sans-serif;font-size:21px;color:var(--ink);margin:26px 0 10px">Ne Zaman Gidilir?</h3>
  ...
  <h3 style="font-family:'Oswald',sans-serif;font-size:21px;color:var(--ink);margin:26px 0 10px">Rota Nasıl Planlanır?</h3>
  ...
  <h3 style="font-family:'Oswald',sans-serif;font-size:21px;color:var(--ink);margin:26px 0 10px">Ulaşım, Konaklama ve Bütçe</h3>
...
<header style="text-align:center;padding:70px 22px 30px">
  ...
  <h1 style="font-family:'Oswald',sans-serif;font-size:clamp(24px,5vw,48px);font-weight:800;letter-spacing:-.02em;margin:16px 0 12px">Türkiye Gezi Rehberi:<br>81 İl, İlçe İlçe Gezilecek Yerler</h1>
...
{regions_html}
{cities_html}
  <h2 style="font-family:'Oswald',sans-serif;font-size:27px;text-align:center;margin:48px 0 4px;color:var(--ink)">Son Gezi Rehberleri</h2>
