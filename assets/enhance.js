...
document.addEventListener("DOMContentLoaded",function(){
  ...
  /* 6) Hava şeridi — yazıda koordinat gömülüyse (open-meteo, keysiz, 6 saat önbellek) */
  if(art && TR){
    ...
    if(g && g.dataset.lat){
      ...
      var showWx=function(d){
        ...
        el.innerHTML="🌤️ 3 günlük hava: "+[0,1,2].map(function(i){
          var day=i===0?"Bugün":new Date(t.time[i]).toLocaleDateString("tr-TR",{weekday:"short"});
